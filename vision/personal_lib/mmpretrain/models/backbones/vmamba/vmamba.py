# based on https://github.com/MzeroMiko/VMamba/tree/main
...
class Linear2d(nn.Linear):
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict, missing_keys, unexpected_keys, error_msgs):
        if prefix + "weight" in state_dict.keys():
...
class Backbone_VSSM(VSSM):
    def __init__(self, out_indices=(0, 1, 2, 3), pretrained=None, norm_layer="ln2d", use_pretrained_last_norm=True, **kwargs):
        ...
        self.use_pretrained_last_norm = use_pretrained_last_norm
